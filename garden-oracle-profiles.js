...
(function(root){
  ...
  const majors = [
    {
      id: 0, tarot: 'The Fool', openName: 'Gieo Vào Gió', closedName: 'Bay Vô Hướng',
    ...
    {
      id: 1, tarot: 'The Magician', openName: 'Gọi Gió Về', closedName: 'Giữ Gió Trong Tay',
      element: 'Air', family: 'Major',
    ...
    {
      id: 3, tarot: 'The Empress', openName: 'Vườn Ươm Sinh Sôi', closedName: 'Vườn Cạn Kiệt Sức',
    ...
    {
      id: 10, tarot: 'Wheel of Fortune', openName: 'Gió Cuốn Sang Mùa', closedName: 'Mùa Cũ Giữ Lại',
      element: 'Fire', family: 'Major',
    ...
    {
      id: 12, tarot: 'The Hanged Man', openName: 'Treo Mình Lơ Lửng', closedName: 'Níu Mãi Không Buông',
      element: 'Water', family: 'Major',
    ...
    {
      id: 13, tarot: 'Death', openName: 'Bông Tàn Buông Hạt', closedName: 'Mùa Tàn Giữ Xác',
      element: 'Water', family: 'Major',
    ...
    {
      id: 14, tarot: 'Temperance', openName: 'Hai Gió Hòa Nhau', closedName: 'Gió Chọi Chênh Chao',
      element: 'Fire', family: 'Major',
    ...
    {
      id: 15, tarot: 'The Devil', openName: 'Thấy Rễ Đang Trói', closedName: 'Tự Buộc Đất Tối',
      element: 'Earth', family: 'Major',
    ...
    {
      id: 16, tarot: 'The Tower', openName: 'Tháp Gãy Tung Bay', closedName: 'Tường Nứt Giữ Lại',
      element: 'Fire', family: 'Major',
    ...
    {
      id: 17, tarot: 'The Star', openName: 'Bay Theo Ánh Sao', closedName: 'Quên Đường Sao Chỉ',
      element: 'Air', family: 'Major',
    ...
    {
      id: 19, tarot: 'The Sun', openName: 'Nắng Đánh Thức Sáng', closedName: 'Nắng Ép Khép Lại',
      element: 'Fire', family: 'Major',
    ...
    {
      id: 21, tarot: 'The World', openName: 'Vườn Nở Quanh Hạt', closedName: 'Mùa Mới Ngoài Cửa',
      element: 'Earth', family: 'Major',
  ...
  const suits = {
    Wands: [
      {
        id: 22, tarot: 'Ace of Wands', openName: 'Bén Lửa Đầu Mùa', closedName: 'Tắt Lửa Giữa Chừng',
      ...
      {
        id: 23, tarot: 'Two of Wands', openName: 'Nhìn Về Chân Trời', closedName: 'Ngại Rời Cành Quen',
        element: 'Fire', family: 'Wands',
      ...
      {
        id: 24, tarot: 'Three of Wands', openName: 'Gió Mang Tin Về', closedName: 'Đợi Tin Quên Nhìn',
        element: 'Fire', family: 'Wands',
      ...
      {
        id: 26, tarot: 'Five of Wands', openName: 'Cọ Mình Giữa Đàn', closedName: 'Va Nhau Vô Cớ',
        element: 'Fire', family: 'Wands',
      ...
      {
        id: 27, tarot: 'Six of Wands', openName: 'Được Tung Lên Cao', closedName: 'Cao Mà Lòng Thấp',
        element: 'Fire', family: 'Wands',
      ...
      {
        id: 29, tarot: 'Eight of Wands', openName: 'Lao Theo Gió Thuận', closedName: 'Vướng Giữa Đường Gió',
        element: 'Fire', family: 'Wands',
      ...
      {
        id: 31, tarot: 'Ten of Wands', openName: 'Mang Trọn Mùa Về', closedName: 'Gánh Hết Không Buông',
        element: 'Fire', family: 'Wands',
      ...
      {
        id: 32, tarot: 'Page of Wands', openName: 'Đưa Tin Mang Lửa', closedName: 'Cầm Lửa Chưa Châm',
        element: 'Fire', family: 'Wands',
      ...
      {
        id: 33, tarot: 'Knight of Wands', openName: 'Phi Qua Đồng Gió', closedName: 'Đốt Đường Chưa Tới',
        element: 'Fire', family: 'Wands',
        ...
        visualMotif: 'Một hạt bồ công anh duy nhất, KHÔNG nhân hoá thành hình người hay sinh vật (không tay chân, không khớp nối rõ rệt), nghiêng gập mạnh về phía trước như đang bung mình lao nhanh — không có ngựa hay vật cưỡi riêng biệt; toàn bộ thân và tán tơ ép sát theo chiều chuyển động, để lại một vệt lửa mảnh phía sau như bụi đường cháy; phía trước mặt, đường chân trời vẫn còn mờ, chưa rõ điểm đến. Khung viền hoa văn dây lá kim tuyến mảnh giữ nguyên đúng như các lá khác trong bộ, không đổi kiểu.',
      ...
      {
        id: 35, tarot: 'King of Wands', openName: 'Cầm Đuốc Dẫn Đường', closedName: 'Giữ Đuốc Chắn Lối',
        element: 'Fire', family: 'Wands',
  ...
  suits.Cups = [
    {
      id: 36, tarot: 'Ace of Cups', openName: 'Hứng Giọt Sương Đầu', closedName: 'Tự Chối Giọt Sương',
    ...
    {
      id: 37, tarot: 'Two of Cups', openName: 'Chung Một Giọt Sương', closedName: 'Lệch Nhịp Rơi',
      element: 'Water', family: 'Cups',
    ...
    {
      id: 38, tarot: 'Three of Cups', openName: 'Cùng Mừng Dưới Mưa', closedName: 'Vui Mà Vẫn Lạc',
      element: 'Water', family: 'Cups',
    ...
    {
      id: 40, tarot: 'Five of Cups', openName: 'Khóc Với Giọt Mất', closedName: 'Mãi Nhìn Giọt Rơi',
      element: 'Water', family: 'Cups',
    ...
    {
      id: 41, tarot: 'Six of Cups', openName: 'Nhớ Cơn Mưa Đầu', closedName: 'Mắc Trong Mưa Cũ',
      element: 'Water', family: 'Cups',
    ...
    {
      id: 42, tarot: 'Seven of Cups', openName: 'Mơ Giữa Trăm Mây', closedName: 'Lạc Giữa Giọt Mơ',
      element: 'Water', family: 'Cups',
    ...
    {
      id: 43, tarot: 'Eight of Cups', openName: 'Rời Vũng Nước Cạn', closedName: 'Quay Lại Vũng Cạn',
      element: 'Water', family: 'Cups',
    ...
    {
      id: 45, tarot: 'Ten of Cups', openName: 'Cầu Vồng Trên Vườn', closedName: 'Giấu Nứt Dưới Vồng',
      element: 'Water', family: 'Cups',
    ...
    {
      id: 46, tarot: 'Page of Cups', openName: 'Nghe Tiếng Nước Thầm', closedName: 'Sợ Nói Điều Thầm',
      element: 'Water', family: 'Cups',
    ...
    {
      id: 47, tarot: 'Knight of Cups', openName: 'Mang Mưa Đến Hẹn', closedName: 'Hứa Mưa Trời Hạn',
      element: 'Water', family: 'Cups',
      ...
      visualMotif: 'Một hạt bồ công anh duy nhất, KHÔNG nhân hoá thành hình người hay sinh vật (không tay chân, không khớp nối rõ rệt), nghiêng nhẹ về phía trước như đang tiến tới với nhịp điềm tĩnh — không có ngựa hay vật cưỡi riêng biệt; một vệt mưa nhẹ cong ngay phía trên nó như một mái che nước tự nhiên; phía trước mặt, mặt đất vẫn còn khô, chưa chạm được giọt mưa nào từ vệt đó. Khung viền hoa văn dây lá kim tuyến mảnh giữ nguyên đúng như các lá khác trong bộ, không đổi kiểu.',
    ...
    {
      id: 48, tarot: 'Queen of Cups', openName: 'Giữ Hồ Cho Vườn', closedName: 'Để Hồ Mình Tràn',
      element: 'Water', family: 'Cups',
    ...
    {
      id: 49, tarot: 'King of Cups', openName: 'Ngồi Yên Giữa Mưa', closedName: 'Khoá Mưa Trong Lòng',
      element: 'Water', family: 'Cups',
  ...
  suits.Swords = [
    {
      id: 50, tarot: 'Ace of Swords', openName: 'Gió Cắt Rõ Đường', closedName: 'Đau Vì Gió Sắc',
    ...
    {
      id: 52, tarot: 'Three of Swords', openName: 'Gió Xuyên Nỗi Đau', closedName: 'Giữ Mãi Vết Cắt',
      element: 'Air', family: 'Swords',
    ...
    {
      id: 54, tarot: 'Five of Swords', openName: 'Nhìn Lại Trận Gió', closedName: 'Thắng Gió Mất Bạn',
      element: 'Air', family: 'Swords',
    ...
    {
      id: 55, tarot: 'Six of Swords', openName: 'Sang Bờ Yên Hơn', closedName: 'Mang Gió Sang Bờ',
      element: 'Air', family: 'Swords',
    ...
    {
      id: 56, tarot: 'Seven of Swords', openName: 'Lặng Lẽ Tìm Đường', closedName: 'Giấu Đường Tự Lạc',
      element: 'Air', family: 'Swords',
    ...
    {
      id: 57, tarot: 'Eight of Swords', openName: 'Thấy Dây Từng Trói', closedName: 'Tin Mãi Không Gỡ',
      element: 'Air', family: 'Swords',
    ...
    {
      id: 58, tarot: 'Nine of Swords', openName: 'Gọi Tên Nỗi Sợ', closedName: 'Thức Trắng Nỗi Sợ',
      element: 'Air', family: 'Swords',
    ...
    {
      id: 59, tarot: 'Ten of Swords', openName: 'Chạm Đáy Thấy Sáng', closedName: 'Nằm Mãi Dưới Gió',
      element: 'Air', family: 'Swords',
    ...
    {
      id: 60, tarot: 'Page of Swords', openName: 'Canh Từng Cơn Gió', closedName: 'Nói Trước Khi Đổi',
      element: 'Air', family: 'Swords',
    ...
    {
      id: 61, tarot: 'Knight of Swords', openName: 'Xé Mây Tìm Thật', closedName: 'Xé Mây Chẳng Nhìn',
      element: 'Air', family: 'Swords',
      ...
      visualMotif: 'Một hạt bồ công anh duy nhất, KHÔNG nhân hoá thành hình người hay sinh vật (không tay chân, không khớp nối rõ rệt), nghiêng gập mạnh xé băng qua một lớp mây mỏng — không có ngựa hay vật cưỡi riêng biệt — để lại một đường rách rõ nét phía sau như vết cắt giữa không trung; tốc độ chuyển động thể hiện rõ qua các vệt mờ dài phía sau. Khung viền hoa văn dây lá kim tuyến mảnh giữ nguyên đúng như các lá khác trong bộ, không đổi kiểu.',
    ...
    {
      id: 63, tarot: 'King of Swords', openName: 'Giữ Luật Cho Gió', closedName: 'Dùng Luật Thay Lòng',
      element: 'Air', family: 'Swords',
  ...
  suits.Pentacles = [
    {
      id: 64, tarot: 'Ace of Pentacles', openName: 'Chạm Đất Tốt Lành', closedName: 'Bỏ Lỡ Đất Chờ',
    ...
    {
      id: 65, tarot: 'Two of Pentacles', openName: 'Lăn Nhịp Nhàng Đất', closedName: 'Chao Đảo Giữa Luống',
      element: 'Earth', family: 'Pentacles',
    ...
    {
      id: 67, tarot: 'Four of Pentacles', openName: 'Giữ Chặt Phần Đất', closedName: 'Siết Đất Cằn Cỗi',
      element: 'Earth', family: 'Pentacles',
    ...
    {
      id: 68, tarot: 'Five of Pentacles', openName: 'Tìm Khe Đất Ấm', closedName: 'Run Ngoài Đất Lạnh',
      element: 'Earth', family: 'Pentacles',
    ...
    {
      id: 69, tarot: 'Six of Pentacles', openName: 'Chia Đất Công Bằng', closedName: 'Cho Đất Giữ Quyền',
      element: 'Earth', family: 'Pentacles',
    ...
    {
      id: 71, tarot: 'Eight of Pentacles', openName: 'Luyện Rễ Mỗi Ngày', closedName: 'Đòi Rễ Hoàn Hảo',
      element: 'Earth', family: 'Pentacles',
    ...
    {
      id: 72, tarot: 'Nine of Pentacles', openName: 'Nở Một Mình Vườn', closedName: 'Đủ Đầy Vẫn Lẻ',
      element: 'Earth', family: 'Pentacles',
    ...
    {
      id: 73, tarot: 'Ten of Pentacles', openName: 'Nối Vào Hàng Tổ', closedName: 'Gánh Vườn Người Trước',
      element: 'Earth', family: 'Pentacles',
    ...
    {
      id: 75, tarot: 'Knight of Pentacles', openName: 'Đi Chậm Mà Chắc', closedName: 'Dừng Giữa Ruộng Quen',
      element: 'Earth', family: 'Pentacles',
      ...
      visualMotif: 'Một hạt bồ công anh duy nhất, KHÔNG nhân hoá thành hình người hay sinh vật (không tay chân, không khớp nối rõ rệt), trôi là là chậm rãi, đều đặn qua một cánh đồng rộng với các luống đất song song trải dài — không có ngựa hay vật cưỡi riêng biệt; dấu vết để lại phía sau đều tăm tắp, không có khoảng dừng nào bất thường — ngoại trừ một điểm gần cuối nơi vệt di chuyển hơi khựng lại. Khung viền hoa văn dây lá kim tuyến mảnh giữ nguyên đúng như các lá khác trong bộ, không đổi kiểu.',
    ...
    {
      id: 76, tarot: 'Queen of Pentacles', openName: 'Ủ Ấm Đất Vườn', closedName: 'Ủ Đất Quên Mình',
      element: 'Earth', family: 'Pentacles',
    ...
    {
      id: 77, tarot: 'King of Pentacles', openName: 'Giữ Vườn Vững Bền', closedName: 'Giữ Vườn Khoá Cổng',
      element: 'Earth', family: 'Pentacles',
